    ...
    <ScrollView style={{backgroundColor: Gcolor.placeholdertext}}>
      ...
      <View style={styles.mainview}>
        ...
        <View style={styles.boxtime}>
          <View style={styles.row}>
            <Text style={styles.rowtxt}>All Days 1/3</Text>
            <Image style={{marginRight: wp(4)}} source={icons.BluePlus} />
          </View>
          <View style={styles.row}>
            <Text
              style={{
          ...
          <View style={{flexDirection: 'row', justifyContent: 'space-between'}}>
            ...
            <Text style={{marginTop: hp(1), marginRight: wp(4)}}>
              ___ : ___ ___
            </Text>
          </View>
        </View>
      ...
      <View style={styles.btnview}>
        ...
        <GButton
          ...
          text={'Submit'}
          onPress={() => props.navigation.navigate('AddNewItem9')}
        />
      </View>
    </ScrollView>
  );
...
const styles = StyleSheet.create({
  ...
  boxtime: {
    ...
    width: wp(72),
    borderRadius: 8,
    borderColor: Gcolor.borderBottomLine,
    borderWidth: 1,
  },
  time: {
    marginLeft: wp(2),
